...
| ~~P12~~ | ~~Llama family 내부 스케일 축 — 8B vs 70B(/405B)~~ | **완료 (2026-09-12)**. 70B Track A(수동 device_map) 성공 + 자체헤드 vs 8B전이헤드 대조로 "스케일업 반례"가 전이헤드 confound였음을 확정(status-2026-09-09.md §3) + head_n=80 재탐색으로 heldout 표본 15→60쌍 확대, important_instructions·tool_knowledge 두 공격축 모두 net 억제 유지 재확인(status-2026-09-12.md §2). 후속 후보(k-sweep, utility 손상 원인 정밀화)는 별도 항목으로 이월 |
