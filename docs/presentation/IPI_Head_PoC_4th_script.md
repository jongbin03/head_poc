...
>
> ✅ **확정 (2026-09-07)** — 서론 2슬라이드 분리 · S8 4모델 injection_task 분해표 ·
> S6/S7 표본 확대 서술 정정 · **S11 재작성**(32B 4bit는 GPU 고정 시 결정론적, "비결정성"은
> Blackwell 커널이 32B 손상시킨 GPU 아키텍처 차이 — feedback 2.1.20) · 옛 S12~S15 →
> S12 한 장. `build_deck_4th.py`·pptx(12슬라이드) 반영 완료. 세션 요약은
> [status-2026-09-07.md](../status-2026-09-07.md).
